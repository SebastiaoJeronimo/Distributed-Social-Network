...
import sd2223.trab1.server.sharedServiceLogic.sharedFeed;
...
public class SoapFeedWebService extends SoapWebServices<FeedsException> implements FeedsService {

    static Logger Log = Logger.getLogger(SoapFeedWebService.class.getName());

    final Feeds impl;

    public SoapFeedWebService() {
        super((result) -> new FeedsException(result.error().toString()));
        this.impl = new sharedFeed();
    }
